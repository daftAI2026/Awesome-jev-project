...
- [**awesome-jev**](https://github.com/yibie/awesome-jev) - Curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's System One model. `Python`
- [**awesome-jev**](https://github.com/AnotiaWang/awesome-jev) - Curated list of awesome Jev / TypeSafe System One applications, libraries, and resources.
- [**awesome-jev**](https://github.com/hellogumbo/awesome-jev) - A community directory of projects built on Jev, TypeSafe AI's System One model. `HTML`
...
- [**jev-me**](https://github.com/jon-devlapaz/jev-me) - jev-me is grill-me with jev. `Python`
...
- [**jev_stock**](https://github.com/sosopop/jev_stock) - An experimental JEV-powered framework for forecasting short-term stock price direction from structured market data. `Python`
...
- [**Typesafe_chess_eval**](https://github.com/AliceRoselia/Typesafe_chess_eval) - An evaluation of typesafe AI chess. As it turns out, the AI isn't doing really well even though chess is not a particularly open-ended game. Still, it's only a prototype and this probably wasn't optimzied for games. `Python`
...
- [**hundred**](https://github.com/jammaru/hundred) - 100 AI NPCs live in a tiny town. Jev chooses the next action; the world writes the story. `TypeScript`
...
- [**computer_use**](https://github.com/paulsmith/computer_use) - macOS computer use driven by Jev (TypeSafe System One) as the decision maker. `Go`
...
- [**jev-review**](https://github.com/NiazMorshed2007/jev-review) - Local-first MCP plugin for continuous software-quality review by AI coding agents, powered by Jev. `TypeScript`
...
- [**ruby_llm-typesafe**](https://github.com/kieranklaassen/ruby_llm-typesafe) - TypeSafe structured-output provider for RubyLLM 2. `Ruby`
...
- [**typesafe-dotnet-sdk**](https://github.com/saibimajdi/typesafe-dotnet-sdk) - Community .NET SDK for the TypeSafe AI System One API — typed noul, choice, and score questions with structured, confidence-scored answers. Not affiliated with TypeSafe AI. `C#`
- [**typesafe-sdk**](https://github.com/joshmn/typesafe-sdk) - Ruby client for typesafe.ai. `Ruby`
- [**super-jev**](https://github.com/Kevthetech143/super-jev) - A small, extensible decision-to-action harness for TypeSafe Jev. `TypeScript`
...
- [**typesafe_ai**](https://github.com/hfiguera/typesafe_ai) - An Elixir client for TypeSafe AI with typed responses and bounded concurrency. `Elixir`
- [**typesafe.zig**](https://github.com/mattneel/typesafe.zig) - An idiomatic Zig client for the TypeSafe AI API. `Zig`
- [**jev-jp-address**](https://github.com/smasato/jev-jp-address) - Jev (TypeSafe) 性能評価プロジェクト — 日本郵便 KEN_ALL をマスタに、AI SDK 経由の Jev が住所のあいまい一致にどこまで使えるかを検証. `TypeScript`
- [**tinyjevclient**](https://github.com/tinyhumansai/tinyjevclient) - An integration with jev by typesafe.ai in Rust. `Rust`
- [**typesafe_ai**](https://github.com/typesend/typesafe_ai) - Typed Elixir client for TypeSafe AI and its Jev System One model, with offline test stubs, concurrent fan-out, and atom-keyed answers. `Elixir`
...
- [**typesafe_sdk_ex**](https://github.com/vinnie357/typesafe_sdk_ex) - Typesafe AI SDK in Elixir using Req. `Elixir`
...
- [**pi-jev**](https://github.com/y0usaf/pi-jev) - TypeSafe Jev as a decision layer for the Pi coding agent: a measured tool-call gate plus jev_ask for typed, calibrated answers. `TypeScript`
...
- [**typesafe-on-neon**](https://github.com/andrelandgraf/typesafe-on-neon) - Neon Function proxy for the Neon AI Gateway with TypeSafe Jev routing. `TypeScript`
...
- [**calibre**](https://github.com/FirasSX914/calibre) - Measure when to use Jev and other models on your data, then route accordingly. `Python`
...
- [**pg_typesafe**](https://github.com/giuliosmall/pg_typesafe) - Pre-alpha PostgreSQL extension for TypeSafe AI (Jev) categorical classification. `C`
...
- [**toolgate**](https://github.com/ndolinschi/toolgate) - Agent tool/MCP call gate — allow / ask_human / deny via TypeSafe Jev. `TypeScript`
...
- [**omp-typesafe**](https://github.com/siddicky/omp-typesafe) - TypeSafe AI (Jev) adversarial reviewer and typesafe_ask tool for the omp coding agent. `TypeScript`
...
- [**jev-rerank**](https://github.com/hev/jev-rerank) - Use Jev (TypeSafe's System One model) as a calibrated reranker: one call, up to 30 documents, a probability per document. Apache-2.0. `Python`
...
- [**spendbrake**](https://github.com/ndolinschi/spendbrake) - Agent budget brake — continue / downgrade_model / stop via TypeSafe Jev. `TypeScript`
...
- [**system-one-adapter-rust**](https://github.com/codeitlikemiley/system-one-adapter-rust) - Rust port of TypeSafe system-one-adapter (LLM-backed system_one evaluations). `Rust`
