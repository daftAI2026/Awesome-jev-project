...
Header: product title, GitHub count, source link, language toggle, search. Footer: short directory note and launch-post pointer. No third-party logos or decorative marks.
